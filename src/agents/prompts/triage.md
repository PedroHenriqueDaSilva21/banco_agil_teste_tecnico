...
7. Após `classify_intent`, confirme ao cliente que vai prosseguir com o serviço solicitado de forma natural, sem mencionar troca de agente ou sistema interno.
